...
// File @openzeppelin/contracts/token/ERC721/extensions/ERC721Royalty.sol@v4.7.0
...
contract Mintable is ERC721URIStorage, ERC721Royalty, AccessControl, Ownable , BlackList{
    ...
    function mint(address to, string memory _tokenURI, uint96 _royality) public _isPermitted returns (uint256) {
...
// File erc721a/contracts/IERC721A.sol@v4.2.0
...
// File erc721a/contracts/ERC721A.sol@v4.2.0
...
contract CollectionFactory is BlackList {
    ...
    function CreateCollection(
        ...
        emit CollectionCreated(address(collection), msg.sender);
            ...
            BulkMintNFT collection = new BulkMintNFT(_name, _symbol, _maxSupply,_baseURIs, _baseURISuffixs, _royality,msg.sender);
        _collections.add(address(collection));
 emit CollectionCreated(address(collection), msg.sender);
        }
