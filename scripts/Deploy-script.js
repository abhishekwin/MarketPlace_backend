...
// ERC20
  ...
  let blacklist;
  if((contractList[0].blacklist !== "") && (network.name === 'goerli')){
  ...
  let erc721Token ;
  if((contractList[0].erc721Token !== "") && (network.name === 'goerli')){
  ...
  console.log("ERC721Token   deployed to:", erc721Token.address);
    ...
    let marketPlace;
    if((contractList[0].marketPlace !== "") && (network.name === 'goerli')){
  ...
  let collectionArray;
  if ((contractList[0].collectionArray !== "") && (network.name === 'goerli')){
  ...
  let contractFactory;
  if ((contractList[0].contractFactory !== "") && (network.name === 'goerli')){
